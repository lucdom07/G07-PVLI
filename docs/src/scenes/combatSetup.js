...
export default class CombatSetup extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('setupBackgrou','assets/backgrounds/australiaaSetup.png')
    ...
    create() {
        ...
        this.add.image(this.sys.game.canvas.width*0.5, this.sys.game.canvas.height*0.5,'setupBackgrou');
