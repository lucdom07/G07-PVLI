...
export default class Animation extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('combatBackgroun','assets/backgrounds/australiaaaCombat.png')
    }
    ...
    create(){
        ...
        this.add.image(this.sys.game.canvas.width*0.5, this.sys.game.canvas.height*0.5,'combatBackgroun');
